void DrawRate()
{
  ...
  const vector<eBeam_t> v_eBeam{{5,41,1,0}, {5,41,10,0}, {5,41,100,0}, {10,100,1,1}, {10,100,10,1}, {10,100,100,1}, {10,100,1000,1}, {18,275,1,2}, {18,275,10,2}, {18,275,100,2}, {18,275,1000,2}};
  ...
  Double_t ntwr = h_twr->GetMaximum();
  ...
  for(Int_t ib=0; ib<nb; ib++)
  {
    ...
    g_rate[ib]->GetXaxis()->SetTitle("Q^{2}_{min} (GeV)");
    g_rate[ib]->GetXaxis()->SetLimits(0.5, 2e3);
    g_rate[ib]->GetYaxis()->SetRangeUser(0.03, 0.07);
