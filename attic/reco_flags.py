...
if __name__ == "__main__":
    ...
    parser.add_argument('--xml_files', default="${DETECTOR_PATH}/${DETECTOR_CONFIG}.xml", help="Comma separated list of XML files describing the DD4hep geometry")
    ...
    default_parameters = [
        ...
        f"-Pdd4hep:xml_files={args.xml_files}",
